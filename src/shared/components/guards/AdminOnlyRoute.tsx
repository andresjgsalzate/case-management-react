    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <div className="mx-auto h-12 w-12 rounded-full bg-yellow-100 dark:bg-yellow-900/20 flex items-center justify-center">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Necesitas estar logueado y activo para acceder a esta sección.
          </p>
        </div>
      </div>
    );

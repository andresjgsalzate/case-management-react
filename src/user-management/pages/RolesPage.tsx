...
export function RolesPage() {
  ...
  if (isLoading) {
    return (
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Gestión de Roles</h1>
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">{rolesData.roles.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Usuarios Asignados</p>
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                  {isLoadingStats ? (
                    <div className="w-8 h-6 bg-gray-200 dark:bg-gray-600 rounded animate-pulse"></div>
                  ) : (
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Permisos Asignados</p>
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                  {isLoadingStats ? (
                    <div className="w-8 h-6 bg-gray-200 dark:bg-gray-600 rounded animate-pulse"></div>
                  ) : (
      ...
      <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-md border border-gray-200 dark:border-gray-700">
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          {rolesData?.roles.map((role) => (
            <li key={role.id} className="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <div className="flex-1">
                  <div className="flex items-center">
                    ...
                    {role.is_active ? (
                      ...
                      <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/20 text-red-800 dark:text-red-400">
                        Inactivo
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mt-2 flex items-center space-x-4">
                    <div className="flex items-center space-x-2">
                      {isLoadingStats ? (
                        <>
                          <div className="inline-block w-16 h-5 bg-gray-200 dark:bg-gray-600 rounded-full animate-pulse"></div>
                          <div className="inline-block w-16 h-5 bg-gray-200 dark:bg-gray-600 rounded-full animate-pulse"></div>
                        </>
                      ) : (
                        <>

-- =========================================
-- SCRIPT DE CREACIÓN COMPLETA DE ESQUEMA
-- Base de datos: Case Management System
-- Fecha: Enero 2025
-- =========================================

-- NOTA: Este script debe ejecutarse en orden para mantener las dependencias
...
-- =========================================
-- 2. TABLAS DEPENDIENTES DE AUTH.USERS
-- =========================================
...
-- Tipos de documentos de solución
CREATE TABLE IF NOT EXISTS public.solution_document_types (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
-- Tags de soluciones
CREATE TABLE IF NOT EXISTS public.solution_tags (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  name character varying NOT NULL UNIQUE,
  description text,
  color character varying DEFAULT '#6B7280'::character varying,
...
-- =========================================
-- 5. TABLAS DE TIEMPO Y ENTRADAS
-- =========================================

-- Entradas de tiempo para casos
...
-- Entradas de tiempo manual para casos
...
-- Entradas de tiempo manual para TODOs
...
-- =========================================
-- 6. TABLAS DE DOCUMENTACIÓN Y SOLUCIONES
-- =========================================
...
-- Versiones de documentos de solución
CREATE TABLE IF NOT EXISTS public.solution_document_versions (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  document_id uuid,
  content jsonb NOT NULL,
...
-- Tags de documentos de solución
CREATE TABLE IF NOT EXISTS public.solution_document_tags (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.disposiciones_scripts (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  fecha date NOT NULL,
  case_id uuid,
...
-- Log de eliminación de archivos
...
BEGIN
    ...
    RAISE NOTICE 'Total de tablas creadas: 28';
    RAISE NOTICE 'Fecha de creación: %', NOW();
END $$;

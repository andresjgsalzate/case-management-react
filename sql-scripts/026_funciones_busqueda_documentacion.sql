...
DO $$
BEGIN
    RAISE NOTICE 'Funciones de búsqueda creadas exitosamente:';
    RAISE NOTICE '1. search_docs_v2 - Para búsqueda rápida con fragmentos';
    RAISE NOTICE '2. search_documents_full - Para búsqueda completa con filtros';
    RAISE NOTICE '3. get_search_suggestions - Para autocompletado de búsqueda';
    RAISE NOTICE 'Todas las funciones están disponibles para usuarios autenticados';
END $$;
